...
void ScalarReplacementPass::CreateReplacementVariables(
  ...
  std::unique_ptr<absl::flat_hash_set<uint64_t>> components_used =
...
std::unique_ptr<absl::flat_hash_set<uint64_t>>
ScalarReplacementPass::GetUsedComponents(Instruction* inst) {
  std::unique_ptr<absl::flat_hash_set<uint64_t>> result(
      new absl::flat_hash_set<uint64_t>());
